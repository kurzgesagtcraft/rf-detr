...
Traceback (most recent call last):
  File "d:\vscode\Roo_Code\rf-detr\rfdetr\main.py", line 1022, in <module>
    model.train(callbacks=DefaultDict(list), **config)
  File "d:\vscode\Roo_Code\rf-detr\rfdetr\main.py", line 383, in train
    train_stats = train_one_epoch(
  File "d:\vscode\Roo_Code\rf-detr\rfdetr\engine.py", line 124, in train_one_epoch
    outputs = model(new_samples, new_targets)
  File "D:\kurzcraft\anaconda3\envs\nightdetect\lib\site-packages\torch\nn\modules\module.py", line 1751, in _wrapped_call_impl
    return self._call_impl(*args, **kwargs)
  File "D:\kurzcraft\anaconda3\envs\nightdetect\lib\site-packages\torch\nn\modules\module.py", line 1762, in _call_impl
    return forward_call(*args, **kwargs)
  File "d:\vscode\Roo_Code\rf-detr\rfdetr\models\lwdetr.py", line 146, in forward
    features, poss = self.backbone(samples)
  File "D:\kurzcraft\anaconda3\envs\nightdetect\lib\site-packages\torch\nn\modules\module.py", line 1751, in _wrapped_call_impl
    return self._call_impl(*args, **kwargs)
  File "D:\kurzcraft\anaconda3\envs\nightdetect\lib\site-packages\torch\nn\modules\module.py", line 1762, in _call_impl
    return forward_call(*args, **kwargs)
  File "d:\vscode\Roo_Code\rf-detr\rfdetr\models\backbone\__init__.py", line 27, in forward
    x = self[0](tensor_list)
  File "D:\kurzcraft\anaconda3\envs\nightdetect\lib\site-packages\torch\nn\modules\module.py", line 1751, in _wrapped_call_impl
    return self._call_impl(*args, **kwargs)
  File "D:\kurzcraft\anaconda3\envs\nightdetect\lib\site-packages\torch\nn\modules\module.py", line 1762, in _call_impl
    return forward_call(*args, **kwargs)
  File "d:\vscode\Roo_Code\rf-detr\rfdetr\models\backbone\backbone.py", line 133, in forward
    feats = self.encoder(tensor_list.tensors)
  File "D:\kurzcraft\anaconda3\envs\nightdetect\lib\site-packages\torch\nn\modules\module.py", line 1751, in _wrapped_call_impl
    return self._call_impl(*args, **kwargs)
  File "D:\kurzcraft\anaconda3\envs\nightdetect\lib\site-packages\torch\nn\modules\module.py", line 1762, in _call_impl
    return forward_call(*args, **kwargs)
  File "d:\vscode\Roo_Code\rf-detr\rfdetr\models\backbone\dinov2.py", line 164, in forward
    assert x.shape[2] % 14 == 0 and x.shape[3] % 14 == 0, f"Dinov2 requires input shape to be divisible by 14, but got {x.shape}"
AssertionError: Dinov2 requires input shape to be divisible by 14, but got torch.Size([2, 3, 640, 1137])
